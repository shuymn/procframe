...
func NewEchoServiceCLIRunner(h EchoServiceHandler, opts ...cli.Option) *cli.Runner {
	node_echo_run := &cli.Node{
		...
		Run: func(ctx context.Context, args []string, stdout io.Writer) error {
			...
			resp, err := procframe.InvokeUnary(ctx, procframe.CallSpec{Procedure: "/echo.v1.EchoService/Echo", Transport: procframe.TransportCLI, Shape: procframe.CallShapeUnary}, &procframe.Request[EchoRequest]{
				Msg:  req,
