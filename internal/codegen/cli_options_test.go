...
func (stubCliOptionsHandler) DefaultEnabled(
	_ context.Context, _ *procframe.Request[testv1.PingRequest],
) (*procframe.Response[testv1.PingResponse], error) {
	return &procframe.Response[testv1.PingResponse]{Msg: &testv1.PingResponse{Result: "ok"}}, nil
}
...
func TestCliOptionsTestService_CLIRouting(t *testing.T) {
	...
	runner := testv1.NewCliOptionsTestServiceCLIRunner(
